          ...
          <table className="min-w-full leading-normal">
            <thead>
              <tr>
                ...
                <th class={tableHeaderClass}>City</th>
                <th class={tableHeaderClass}>Recent Upload Speed</th>
                <th class={tableHeaderClass}>Recent Upload Speed Units</th>
                <th class={tableHeaderClass}>Number of measurements</th>
              </tr>
            </thead>
            <tbody>
              {loadedPlaces.map((place, index) => {
                return (
                  <tr key={index}>
                    ...
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                      <p class="text-gray-900 whitespace-no-wrap">{place.most_recent_download_units}</p>
                    </td>
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
